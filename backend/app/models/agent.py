...
class Agent(Base):
    ...
    #   'claude_code' (default), 'openclaw', 'hermes', or 'codex'. Controls
    #   which adapter the bridge installer enables and which
    #   session.start.adapter the server sends. Ignored for native agents.
