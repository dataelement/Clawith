...
BUILTIN_TOOLS = [
    ...
    # --- Project task tools (Phase 3 — deliverables) ---
    {
        "name": "list_project_tasks",
        "display_name": "List Project Tasks",
        "description": "List the current project's tasks (Phase 3 deliverables). Available only inside a project chat. Each line shows status, title, assignee, due date, task id, AND the project files linked to that task (filenames inlined, up to 3, with total count). Use this to discover what files belong to a task before reading them.",
        "category": "project",
        "icon": "📋",
        "is_default": True,
        "parameters_schema": {
            ...
            "properties": {
                "status": {
                    "type": "string",
                    "description": "Filter by status: 'todo' | 'doing' | 'done' | 'blocked' | 'all' (default).",
                    "default": "all",
                },
            },
        },
    ...
    },
    {
        ...
        "display_name": "Create Project Task",
        "description": "Create a new task in the current project. Available only inside a project chat. Use to capture a new deliverable on the user's behalf or as part of self-organising the work.",
        "category": "project",
        "icon": "➕",
        "is_default": True,
        "parameters_schema": {
            "type": "object",
            "properties": {
                "title": {"type": "string", "description": "Short task title (≤300 chars)."},
                "description": {"type": "string", "description": "Optional markdown description."},
                "status": {"type": "string", "description": "Initial status. Default 'todo'.", "default": "todo"},
                "due_date": {"type": "string", "description": "Optional ISO 8601 due date (e.g. '2026-05-10')."},
                "assign_to_self": {"type": "boolean", "description": "If true, the agent assigns the task to itself."},
            },
            "required": ["title"],
        },
        "config": {},
    ...
    },
    {
        ...
        "display_name": "Update Project Task",
        "description": "Update fields on an existing project task — typically status (todo/doing/done/blocked) or description. Available only inside a project chat. Setting status='done' fills completed_at automatically.",
        "category": "project",
        "icon": "✍️",
        "is_default": True,
        "parameters_schema": {
            "type": "object",
            "properties": {
                "task_id": {"type": "string", "description": "UUID of the task (from list_project_tasks)."},
                ...
                "assigned_agent_id": {"type": "string", "description": "Reassign to another agent (UUID)."},
            },
            "required": ["task_id"],
        },
        "config": {},
    ...
    },
    {
        ...
        "display_name": "Link File to Project Task",
        "description": "Attach a project file to a task so it's visible in the task's linked-files list and survives renames. Available only inside a project chat. Use after producing or identifying the artefact for a task.",
        "category": "project",
        "icon": "🔗",
        "is_default": True,
        "parameters_schema": {
            ...
            "properties": {
                ...
                "filename": {"type": "string", "description": "Filename in the project workspace, e.g. 'posts/draft-1.md'."},
            },
    ...
    },
    {
        ...
        "parameters_schema": {
            "type": "object",
            "properties": {
                "src_path": {"type": "string", "description": "Current path of the file/directory, e.g. 'workspace/draft.md' or '.project/<pid>/foo.md'"},
                "dst_path": {"type": "string", "description": "New full path. Parent directories are auto-created. Refuses overwrites — pick a different name or delete the destination first."},
            },
    ...
    },
    {
        ...
        "parameters_schema": {
            "type": "object",
            "properties": {
                "path": {"type": "string", "description": "Path of the file/directory to rename"},
                "new_name": {"type": "string", "description": "New filename (just the name, no slashes). If you omit the extension, the original file's extension is kept automatically."},
            },
    ...
    },
    {
        ...
        "parameters_schema": {
            "type": "object",
            "properties": {
                "hours": {"type": "integer", "description": "Lookback window in hours. Default 24, max 720 (30 days).", "default": 24},
            },
        },
        "config": {},
        "config_schema": {},
